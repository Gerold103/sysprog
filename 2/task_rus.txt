...
Файлы parser.h и parser.c уже реализуют парсер. Вы свобдны взять
его, или реализовать свой, или взять какой-нибудь еще.

Файл parser_test.c можно игнорировать. Он используется для
...
Единственный файл, который требует вашего внимания - solution.c.
...
- Можно использовать уже написанный парсер из parser.h и .c, с
  примером использования в solution.c.
...
- Попробуйте реализовать простой main.c пример с одной
