 ...
 * All pending messages of the channel are deleted and lost. All
 * the coroutines suspended on this channel are woken up and get
 * the error that the channel is missing.
